...
# Status emoji [emoji here and display on the bottom right side of profile pic]
status:
  # icon: ☕️
...
bio: My research interests include social-ecological policy, land systems, and statistics.
interests:
  - ecosystem services
  - land systems
  - policy evaluation
...
profiles:
  ...
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/brianerobinson/
...
#{{< icon name="file-arrow-down" pack="fas" >}} For more details on Brian Robinson, see his {{<"uploads/robinson_cv.pdf" "newtab" >}}CV here{{<>}}.
